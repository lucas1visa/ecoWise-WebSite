...
const Footer = () => {
  ...
  return (
    <div className={isDarkMode ? "modo-oscuro" : "cart-modo-normal"}>
      <footer
        className={"text-white py-4 color-footer-dark color-footer-light"}
      >
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
           ...
           {/*  <div className="mb-4 md:mb-0 text-center md:text-left text-white">
            ...
            <a className="footerEtiquetasA" href="#" onClick={handleTermsShow}>
            ...
            <Modal show={showFAQModal} onHide={handleFAQClose}>
              ...
              <Modal.Body>
                ...
                <p>
                  ...
                  navega por nuestras categorías de productos, elige los
                  artículos que deseas comprar y agrégalos al carrito de
                  compras. Luego, procede al pago, ingresa tu información de
                  envío y elige el método de pago. Una vez que se confirme el
                  pedido, recibirás un correo de confirmación.
                </p>
                ...
                <p>
                  ...
                  procesados y enviados en 5 días hábiles. Te proporcionaremos
                  un número de seguimiento para que puedas rastrear el estado de
            ...
            <Modal show={showTermsModal} onHide={handleTermsClose}>
              ...
              <Modal.Body>
                <p>
                  ...
                  <p>
                    Nuestros productos sustentables están diseñados para
                    promover la sostenibilidad y reducir el impacto ambiental.
                    Nos esforzamos por ofrecer productos de alta calidad que
                    sean funcionales y respetuosos con el medio ambiente.
                  </p>
                  ...
                  <p>
                    ...
                    representación de colores y características puede variar
                    según la configuración de tu pantalla. Si tienes preguntas,
                  ...
                  <p>
                    ...
                    Utilizamos materiales de embalaje sostenibles siempre que
                    sea posible para reducir la huella de carbono.
                  </p>
                  ...
                  <p>
                    ...
                    de acuerdo con nuestras políticas de privacidad. Utilizamos
                  ...
                  <p>
                    ...
                    términos y condiciones, por favor contáctanos a través de la
            ...
            <Modal show={ShowPagosModal} onHide={handlePagosClose}>
              ...
              <Modal.Body>
                ...
                <p className="parrafos">
                  En la actualidad, realizar compras en línea se ha convertido
                  en una parte fundamental de nuestras vidas, permitiéndonos
                  acceder a una amplia gama de productos y servicios desde la
                  comodidad de nuestro hogar. Sin embargo, una de las
                  preocupaciones más comunes al comprar en línea es la seguridad
                  de los métodos de pago. Es aquí donde Mercado Pago entra en
                  escena, ofreciendo una solución integral que brinda
                  tranquilidad y confianza a los compradores en línea.
                </p>
                ...
                <p className="parrafos">
                  ...
                  autorizados. Esto permite a los compradores elegir el método
                  que les resulte más conveniente y familiar, adaptándose a sus
                ...
                <h3 className="metodopago">
                  Proceso de Compra Sencillo y Transparente
                </h3>
                <p className="parrafos">
                ...
                <p className="parrafos">
                  Mercado Pago va más allá al ofrecer una protección al
                  comprador. Si surge algún problema con la compra, como la no
                  recepción del producto o servicios no conformes, los usuarios
                  tienen la posibilidad de abrir una disputa y recibir
                  asistencia para resolver el problema de manera justa y
                  equitativa.
                </p>
                <h3 className="metodopago">Respaldo de una Marca Confiable</h3>
                <p className="parrafos">
                  La reputación de Mercado Pago como una plataforma confiable y
                  reconocida en el ámbito del comercio electrónico agrega un
                  nivel adicional de tranquilidad. Al elegir realizar una
                  transacción a través de Mercado Pago, los compradores pueden
                  confiar en que están tratando con una entidad que valora la
                  seguridad y la satisfacción del cliente.
                </p>
              </Modal.Body>
              <Modal.Footer></Modal.Footer>
            </Modal>
