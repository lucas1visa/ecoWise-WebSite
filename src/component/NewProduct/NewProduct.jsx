...
const NewProduct = () => {
    ...
    <svg aria-hidden="true" role="status" class="inline w-4 h-4 mr-3 text-gray-900 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
